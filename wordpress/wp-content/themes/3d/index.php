...
<div class="xr_ap" id="xr_xr" style="width: 800px; height: 1200px; top:0px; left:50%; margin-left: -400px;">
  ...
  <span class="xr_tl" style="top: -22px;"><span class="xr_s1">3D</span><span class="xr_s2">WAX</span><span class="xr_s1">CARVING.</span><span class="xr_s2">COM</span></span>
	...
	<a href="<?php echo get_template_directory_uri(); ?>/images/12.jpg" class="highslide" onmouseover="hs.headingText=''" onclick="return hs.expand(this, { headingText: '' } )"><img class="xr_ap" src="<?php echo get_template_directory_uri(); ?>/images/4.jpg" alt="CAD jewelry designer" title="CAD jewelry designer" onmousemove="xr_mo(this,0,event)" style="left: 12px; top: 197px; width: 120px; height: 107px;"/></a>
		
	<a href="<?php echo get_template_directory_uri(); ?>/images/13.jpg" class="highslide" onmouseover="hs.headingText=''" onclick="return hs.expand(this, { headingText: '' } )"><img class="xr_ap" src="<?php echo get_template_directory_uri(); ?>/images/5.jpg" alt="CAD jewelry designer" title="CAD jewelry designer" onmousemove="xr_mo(this,0,event)" style="left: 11px; top: 445px; width: 123px; height: 111px;"/></a>
	
	<a href="<?php echo get_template_directory_uri(); ?>/images/14.jpg" class="highslide" onmouseover="hs.headingText=''" onclick="return hs.expand(this, { headingText: '' } )"><img class="xr_ap" src="<?php echo get_template_directory_uri(); ?>/images/6.jpg" alt="CAD jewelry designer" title="CAD jewelry designer" onmousemove="xr_mo(this,0,event)" style="left: 12px; top: 320px; width: 120px; height: 109px;"/></a>
