...
<div class="xr_ap" id="xr_xr" style="width: 800px; height: 1200px; top:0px; left:50%; margin-left: -400px;">
  ...
  <span class="xr_tl" style="top: -22px;"><span class="xr_s1">3D</span><span class="xr_s2">WAX</span><span class="xr_s1">CARVING.</span><span class="xr_s2">COM</span></span>
	...
	<a href="<?php echo get_template_directory_uri(); ?>/images/151.jpg" class="highslide" onmouseover="hs.headingText=''" onclick="return hs.expand(this, { headingText: '' } )"><img class="xr_ap" src="<?php echo get_template_directory_uri(); ?>/images/149.jpg" alt="" title="" onmousemove="xr_mo(this,0,event)" style="left: 16px; top: 241px; width: 151px; height: 137px;"/></a>
	<img class="xr_ap" src="<?php echo get_template_directory_uri(); ?>/images/150.jpg" alt="" title="" style="left: 141px; top: 355px; width: 77px; height: 77px;">
	
 <span class="xr_s7 contact-p" style="position: absolute; left:348px; font-size: 18px; top:235px;">
